...
#     list_filter = ('id_collaborator', 'creation_date', 'Firstname', 'lastname', 'town', 'country')   
#     search_fields = ('id_collaborator', 'creation_date', 'Firstname', 'lastname', 'town', 'country') Permet de mettre une barre de recherche des champs qu on souhaite